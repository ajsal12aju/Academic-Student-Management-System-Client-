...
import BackgroundImage from 'assets/images/logo-dark.svg'; 
        ...
        <Grid container sx={{ height: '100vh', width: '100vw' }}>
            ...
            <Grid
                ...
                sx={{
                    ...
                    alignItems: 'center',
                    background:
                        'linear-gradient(250.38deg, rgb(26, 35, 31) 2.39%, rgb(19, 80, 47) 32.42%, rgb(10, 125, 62) 60.95%, rgb(31, 143, 78) 84.83%, rgb(92, 176, 122) 104.37%)'
                }}
            >
                <Card sx={{ padding: 4, width: '90%', maxWidth: 400, bgcolor: 'rgba(0, 0, 0, 0.7)', color: 'white', borderRadius: 2 }}>
                    ...
                    <Formik
                        ...
                        validationSchema={Yup.object({
                            user_name: Yup.string().user_name('Invalid user_name').required('Required'),
                    ...
                    >
                        {({ values, errors, touched, handleChange, handleBlur, handleSubmit }) => (
                            <form noValidate onSubmit={handleSubmit}>
                                <FormControl fullWidth sx={{ mb: 2 }} error={touched.user_name && !!errors.user_name}>
                                    ...
                                    <OutlinedInput
                                        ...
                                        label="User Name"
                                    />
                                    {touched.user_name && errors.user_name && <FormHelperText>{errors.user_name}</FormHelperText>}
                                </FormControl>
